...
バッジ (Badge) という CI ツールのビルドやテストの結果を表示するアイコンを表示
[![CircleCI](https://circleci.com/gh/metamorLP/damage-calc-4005-v2/tree/master-2017.svg?style=svg)](https://circleci.com/gh/metamorLP/damage-calc-4005-v2/tree/master-2017)
